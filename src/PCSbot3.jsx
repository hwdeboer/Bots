...
function PCSbot3() {
  ...
  const fetchData = () => {
    ...
    const eventSource1 = new EventSource("http://localhost:8000/messagebot3");
  ...
  return (
    <main className="main-container">
      <div className="main-title">
        <h1>Statistics Pancakeswap Bot 3</h1>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div style={{ flex: 8 }}>
            ...
            <div style={{ marginLeft: "0px" }}>
              <h4>ETH: {valueBot2} </h4>
              <h4>USDC: {valueBot4}</h4>
              <h4>WETH: {valueBot3}</h4>
          ...
          <div style={{ flex: 8 }}>
            ...
            <div style={{ marginLeft: "0px" }}>
              ...
              <h4>USDC: {valueBot13}</h4>
              <h4>WETH: {valueBot12}</h4>
          ...
          <div style={{ flex: 8 }}>
            ...
            <div style={{ marginLeft: "0px" }}>
              <h4>ETH: {0} </h4>
              <h4>USDC: {valueBot7}</h4>
              <h4>WETH: {valueBot6}</h4>
              <h4>fee USDC: {valueBot9} </h4>
