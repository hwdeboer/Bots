...
function PCSbot1() {
  ...
  const fetchData = () => {
    ...
    const eventSource1 = new EventSource("http://localhost:8000/messagebot1");
  ...
  return (
    <main className="main-container">
      <div className="main-title">
        <h1>Statistics Pancakeswap Bot 1</h1>
        ...
        <div style={{ display: "flex" }}>
          ...
          <div style={{ flex: 8 }}>
            ...
            <div style={{ marginLeft: "0px" }}>
              ...
              <h4>WBNB: {valueBot7}</h4>
              <h4>fee WBNB: {valueBot8} </h4>
