...
async function writeOutput() {
  ...
  console.log("USD value BTCB in wallet: " + currentValueUSD_tmp2);
  ...
  console.log("Amount liquidity BTBC: " + amount0Human);
  console.log("Amount liquidity WBNB: " + amount1Human);
  console.log("USD value liquidity BTBC: " + amount0USD);
  console.log("USD value liquidity WBNB: " + amount1USD);

  console.log("Amount fees BTBC: " + uncollectedFeesAdjusted_0);
  console.log("Amount fees WBNB: " + uncollectedFeesAdjusted_1);
  console.log("USD value fees BTCB: " + feeAmount0USD);
  ...
  usdValueWBNB = currentValueUSD_tmp3 + amount1USD + feeAmount1USD;
  usdValueCAKE = currentValueUSD_tmp4 + valueCAKEUSD;

  usdValueAll = usdValueBNB + usdValueBTC + usdValueWBNB + usdValueCAKE;
...
async function waitResult2(callback) {
