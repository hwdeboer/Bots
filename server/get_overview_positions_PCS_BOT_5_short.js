...
async function writeOutput() {
  ...
  usdValueBTC = (currentValueUSD_tmp3 + amount1USD + feeAmount1USD).toFixed(0);
...
let exportUsdValueAll5 = 0;

async function waitResult_short5(callback) {
  await readValue();
  exportUsdValueAll5 = usdValueAll; // Update the global variable with the correct value
  callback(exportUsdValueAll5); // Call the callback function with someVariable as argument
}
