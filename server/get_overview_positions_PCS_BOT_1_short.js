...
let exportUsdValueAll1 = 0;

async function waitResult_short1(callback) {
  await readValue();
  exportUsdValueAll1 = usdValueAll; // Update the global variable with the correct value
  callback(exportUsdValueAll1); // Call the callback function with someVariable as argument
}
